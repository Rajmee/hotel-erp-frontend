...
const AddEmployeesLeave = () => {
  ...
  var endDate = format(dates[0].endDate,"MM/dd/yyyy");
    ...
    async function submitForm(e) {
      e.preventDefault();
      await http.post(`${process.env.NEXT_PUBLIC_DOMAIN}/app/hrm/leaves`,{action: "createEmployeeLeaves", description, employee_id, leave_category, duration, date, startDate, endDate})
      .then((res)=>{
